package com.studiozero.projeto.shared.infrastructure.configs.usecases;

import com.studiozero.projeto.shared.infrastructure.repositories.Implements.DashboardRepositoryImpl;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

import com.studiozero.projeto.shared.application.usecases.dashboard.GetActivesUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetBalancesUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetBarFinancesUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetCategoryBalancesUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetClientStatsUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetDashboardDataUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetFrequencysUseCase;
import com.studiozero.projeto.shared.application.usecases.dashboard.GetRecentTimeUseCase;
