...
public class SubJobEntity {
    ...
    public SubJobEntity(UUID id, String title, String description, Double value, LocalDate date, LocalTime startTime,
                        LocalTime expectedEndTime, Boolean needsRoom, Status status, JobEntity jobEntity) {
        if (id == null) {
    ...
    private void validateJob(JobEntity jobEntity) {
        if (jobEntity == null) {
    ...
    public void changeJob(JobEntity newJobEntity) {
        validateJob(newJobEntity);
        this.jobEntity = newJobEntity;
    }
}
